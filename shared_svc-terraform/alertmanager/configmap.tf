#----------------------------------------------------------------
resource "kubernetes_config_map" "alertmanager-config" {
  metadata {
  ...
  data {
    alertmanager.yml = <<EOF
      ...
      - name: alert-slack
        slack_configs:
        - channel: '#k8s-channel-name'
          api_url: https://hooks.slack.com/services/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FMg
          icon_url: https://avatars3.githubusercontent.com/u/3380467
          send_resolved: true
      ...
      - name: alert-emailer
        email_configs:
        - to: k8s@gmail.com     #Receiver Email id
          send_resolved: false
          from: monitoring@gmail.com
          smarthost: 'smtp.gmail.com:587'
          auth_username: monitoring@gmail.com
          auth_password: 12345
          auth_secret: monitoring@gmail.com
